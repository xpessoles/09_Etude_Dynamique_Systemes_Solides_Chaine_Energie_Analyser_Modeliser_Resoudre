...
\textbf{Puissance dissipée dans la liaison engrenage entre 2 et 0 : $\mathcal{P}_{0\rightarrow 2}$ :} 

\textbf{Puissance dissipée dans la liaison pivot entre 3 et 0 : $\mathcal{P}_{0\rightarrow 3}$ :} 

\textbf{Puissance fournie à l'arbre 1 :} 
\textbf{Puissance transmise par l'arbre 3 :} 

\textbf{Calcul des puissances dues aux actions à distance}

\textbf{Puissance due à la pesanteur sur la pièce 1}

\textbf{Puissance due à la pesanteur sur la pièce 3}

\textbf{Puissance due à la pesanteur sur la pièce 2}

\textbf{Calcul des puissances internes}

\textbf{Puissance dissipée dans la liaison engrenage entre 1 et 2 : $\mathcal{P}_{1\rightarrow 2}$ :} 


\textbf{Puissance dissipée dans la liaison pivot entre 2 et 3 : $\mathcal{P}_{3\rightarrow 2}$ :} 
\end{corrige}
